...
namespace LINQWPF
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="StudentsInventory")]
    ...
    partial void DeleteUniversity(University instance);
		...
		public StudentLINQDataContext() : 
				base(global::LINQWPF.Properties.Settings.Default.StudentsInventoryConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCGPAChanging(double value);
    ...
    partial void OnLectureNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LectureName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
	...
	public partial class University : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _UnivarsityName;
    ...
    partial void OnIdChanging(int value);
    partial void OnIdChanged();
    partial void OnUnivarsityNameChanging(string value);
    partial void OnUnivarsityNameChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UnivarsityName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string UnivarsityName
		{
			get
			{
				return this._UnivarsityName;
			}
			set
			{
				if ((this._UnivarsityName != value))
				{
					this.OnUnivarsityNameChanging(value);
					this.SendPropertyChanging();
					this._UnivarsityName = value;
					this.SendPropertyChanged("UnivarsityName");
					this.OnUnivarsityNameChanged();
				}
			}
		}
